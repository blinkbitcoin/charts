...
echo ""
echo "Prerequisites: Tilt running with both LND instances and MinIO"
echo "To just test the backup service,"
echo "can comment the other modules in the dev Tiltfile"
echo ""
